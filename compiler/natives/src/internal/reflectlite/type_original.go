...
func (k Kind) String() string {
	...
	return "kind" + js.Global.Call("String", int(k)).String()
}
...
func (d ChanDir) String() string {
	...
	return "ChanDir" + js.Global.Call("String", int(d)).String()
}
...
func StructOf(fields []StructField) Type {
	...
	for i, field := range fields {
		if field.Name == "" {
			panic("reflect.StructOf: field " + js.Global.Call("String", int(i)).String() + " has no name")
		}
		if !isValidFieldName(field.Name) {
			panic("reflect.StructOf: field " + js.Global.Call("String", int(i)).String() + " has invalid name")
		}
		if field.Type == nil {
			panic("reflect.StructOf: field " + js.Global.Call("String", int(i)).String() + " has no type")
		}
